  ...
  <div class="marketing">
    ...
    <div class="label">
      <el-tabs v-model="activeName2" type="card" @tab-click="handleClick" >
        ...
        <el-tab-pane label="市场码" name="second">市场码</el-tab-pane>
        ...
        <el-tab-pane label="渠道" name="ditch">渠道</el-tab-pane>
        <el-tab-pane label="签约渠道" name="signing">签约渠道</el-tab-pane>
        <el-tab-pane label="营业部门" name="business">营业部门</el-tab-pane>
        <el-tab-pane label="费用码" name="cost ">费用码</el-tab-pane>
        <el-tab-pane label="包价" name="contract ">包价</el-tab-pane>
        <el-tab-pane label="应收账户类型" name="type ">应收账户类型</el-tab-pane>
