    ...
    <div class="basicInfo">
        ...
        <div class="contact">
          ...
          <ul>
            ...
            <li style="height: 46px;vertical-align: top">
              ...
              <span style="font-size: 16px ;vertical-align: top ;margin-left: 20px;margin-top: 5px;width: 40px;" >东经：</span>
              ...
              <span style="font-size: 16px;vertical-align: top;margin-top: 5px;margin-left: 15px;width: 40px">北纬：</span>
              <span style="width: 50px;height: 40px; border: 1px solid rgba(204,204,204,1);margin-left: 10px;line-height: 40px;overflow: hidden;text-overflow: ellipsis">{{group_list.position}}</span>
            ...
            <li style="height: 46px;line-height: 46px">
              ...
              <el-checkbox  v-else v-model="checked" disabled style="display: inline-block">停用</el-checkbox>
            </li>
      ...
      <div class="right">
        ...
        <ul class="establish">
          ...
          <li><button @click="amend">修改</button>  <button @click="omit">删除</button> </li>
    ...
    export default {
      ...
      methods:{
        ...
        full(){
          // debugger
          let that=this;
          let the_url = '/api/v1/common/hotel_group/get_info/'+this.group;  // m命名一个变量,以确保打印和使用的时候this.group是同一个值
          if(the_url === "/api/v1/common/hotel_group/get_info/"){
            // this.group === "" 时,打印this
            console.log(this);
          }
          console.log(the_url);
          that.$axios({
            url: the_url,   // 不使用表达式赋值而是直接引用以前定义的变量,以确保和console.log(the_url);打印的内容一致
            method: "get",
        ...
        omit(){
          ...
          this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
            ...
            this.$axios({
              url:`/api/v1/common/hotel_group/remove/`+this.group,
              method: "post",
              // params:{},
              data:{
        ...
        save(){
          ...
          this.$axios({
            url:`/api/v1/common/hotel_group/update/`+this.group,
            method: "post",
            // params:{},
            data:{
              //集团蒙版的基本信息
