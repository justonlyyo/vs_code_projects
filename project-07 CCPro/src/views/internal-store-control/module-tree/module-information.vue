<template>
  <div class="information">
    <p>模块信息</p>
     <div class="state">
       <span style=" margin-right: 48px;margin-left:100% ">状态</span>
    ...
    <div class="masking" v-show="masking">
      <ul class="mask_information">
        ...
        <li><span >模块代码</span><el-input v-model="code" placeholder="请输入内容" style="width: 300px;"></el-input></li>
        <li>
          <span >模块种类</span>
          <el-input v-model="input_kind"  style="width: 300px;"  :disabled="true" ></el-input>
        </li>
        <li>
          <span >模块类型</span>
        ...
        <li><span >链接</span><el-input v-model="url" placeholder="请输入内容" style="width: 300px;"></el-input></li>
        ...
        <li>
          <span >父级模块</span>
          <el-input v-model="input_father"  style="width: 300px;"  :disabled="true" ></el-input>
        </li>
          ...
          this.$axios({
            ...
            .then(res=>{
              ...
              if(res.data.message==="success"){
                ...
                //       // console.log(this.newlists_info);
                //
                //
                //     }
                //
