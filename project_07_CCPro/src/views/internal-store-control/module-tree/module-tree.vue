  ...
  <div class="module">
    <div class="tree" >
         ...
         <div class="search" style="margin-right: 10px">
           <el-input v-model="input" placeholder="请输入模块名称" ></el-input>
          <button @click="seek">查找</button>
        </div>
          <div class="genre" style="margin-bottom: 10px;margin-right: 10px">
            <span>模块种类:</span>
   ...
   <div class="router">
    ...
    <div class="masking" v-show="masking">
      ...
      <ul class="mask_information">
        ...
        <li><span >模块名称</span><el-input v-model="name" placeholder="请输入内容" style="width: 217px;"  maxlength="8"></el-input></li>
        <li><span >英文描述</span><el-input v-model="desc_en" placeholder="请输入内容" style="width: 217px;" ></el-input></li>
        <li><span >模块代码</span><el-input v-model="code" placeholder="请输入内容"  @blur="unfocused('code', code)"style="width: 217px;" ></el-input></li>
        <li>
          <span >模块种类</span>
          <el-input v-model="root_id"  style="width: 217px;"  :disabled="true" ></el-input>
        <li>
          <span >模块类型</span>
        ...
        <li><span >链接</span><el-input v-model="url" placeholder="请输入内容" @blur="unfocused('url', url)" style="width: 217px;" ></el-input></li>
        <li v-show="bbb">
          <span >父级模块</span>
        ...
        <li v-show="aaa"><span >父级模块</span><el-input v-model="parent_id"   style="width: 217px;"   :disabled="true" ></el-input></li>
...
<script>
  ...
  export default {
        ...
        created: function () {
          let that=this;
          that. newlists_methods();//获取信息列表
          that.module_list_methods();//获取树状结构
          that.kinds_methodes();//获取模块种类  模块类型
              },
        methods: {
          ...
          check_repeat(field, keyword){
           ...
           //全局查找
                seek(){
                  ...
                  //发送查找内容给后台  查找
                  this.$axios({
                    url: ""+this.api+"/v1/common/module/info_list",
                    method: "post",
                    data:{
                      keyword:this.input,
            ...
            //点击加号显示的保存以后向后台发送数据
              ...
              this.$axios.post(""+this.api+"/v1/common/module/add",
                {
                  name:this.name,
