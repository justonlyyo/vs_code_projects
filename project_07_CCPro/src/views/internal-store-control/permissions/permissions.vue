  ...
  <div class="permissions">
          ...
          <el-tree
            ...
            @node-click="handleNodeClick">
                 <span class="custom-tree-node" slot-scope="{ node, data }">
                    ...
                    <span   v-if="data.is_sys===0"  style="position: absolute;right: 20px">
                      <!-- v-show="setpro"-->
    ...
    <div class="masking" v-show="masking">
      ...
      <ul class="mask_information" v-show="role">
        ...
        <li>
          <span >角色组名称</span><el-input v-model="name" placeholder="请输入内容" style="width: 217px;"   ></el-input>
        ...
        <li v-show="pub_hotel"><span >酒店</span><el-input v-model="pub"   style="width: 217px;"  :disabled="true"   placeholder="请输入内容"></el-input></li>
      ...
      <ul class="mask_information" v-show="right_control">
        <!--<div class="hint" v-show="masking_hint">输入内容已存在，请检查后重新输入</div>-->
        <li><span >权限组名称</span><el-input v-model="permission_name" placeholder="请输入内容" style="width: 217px;"  ></el-input></li>
        <li><span >权限组代码</span><el-input v-model="permission_code" placeholder="请输入内容" style="width: 217px;"></el-input></li>
        <li>
        ...
        <li v-show="hotel_pub"><span >酒店</span><el-select v-model="permission_hotel" placeholder="请选择"><el-option
          v-for="item in part_hotel_list"
          :key="item.value"
          :label="item.full_name"
          :value="item.id">
