        ...
        <el-row v-show="$store.state.topNavState==='home'"><!-- 注意：这里就是topNavState作用之处，根据当前路由所在根路由的type值判断显示不同顶部导航菜单 -->
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/firstIndex">房态</el-menu-item>
              <el-menu-item index="/orderList">预定</el-menu-item>
              <el-menu-item index="/customer">宾客</el-menu-item>
              <el-menu-item index="/accountsReceivable">财务</el-menu-item>
              <el-menu-item index="/nightaudit">夜审</el-menu-item>
              <el-menu-item index="/shifting">交接班</el-menu-item>
              <el-menu-item index="/setting/RoomSet">设置</el-menu-item>
