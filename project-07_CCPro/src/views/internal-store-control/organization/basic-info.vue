    ...
    export default {
      ...
      data(){
        return{
         ...
         info:true,//页面打开显示的页面,
          ...
          // group:'',//集团信息的选择框
          selected_group:'',//集团信息的选择框, 修改后的命名
      ...
      methods:{
        ...
        full(){
          debugger
          let that=this;
          console.log('/api/v1/common/hotel_group/get_info/'+this.selected_group);
          that.$axios({
            url: '/api/v1/common/hotel_group/get_info/'+this.selected_group,
            method: "get",
